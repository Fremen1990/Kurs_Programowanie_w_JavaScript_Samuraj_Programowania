...
const chnageSize = () => {
    ...
    liElements.forEach((liElementek) => {
        liElementek.style.display = "block";
        liElementek.style.fontSize = `${size}px`
...
btn.addEventListener("click", chnageSize)